...
public class RParser implements PsiParser
{
	...
	{
		if ( !recursion_guard_( builder_, level_, "command_3" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
		result_ = expr_or_assign( builder_, level_ + 1 );
		result_ = result_ && command_3_1( builder_, level_ + 1 );
		exit_section_( builder_, marker_, null, result_ );
		return result_;
	}

	// ';'?
	private static boolean command_3_1( PsiBuilder builder_, int level_ )
	{
		if ( !recursion_guard_( builder_, level_, "command_3_1" ) )
			return false;
	...
	{
		if ( !recursion_guard_( builder_, level_, "cond" ) )
			return false;
		if ( !nextTokenIs( builder_, R_LEFT_PAREN ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
	...
	{
		if ( !recursion_guard_( builder_, level_, "document" ) )
			return false;
		Marker marker_ = enter_section_( builder_, level_, _NONE_, "<document>" );
		int pos_ = current_position_( builder_ );
		while ( true )
		{
			if ( !command( builder_, level_ + 1 ) )
				break;
			if ( !empty_element_parsed_guard_( builder_, "document", pos_ ) )
				break;
	...
	//     (
	//     	PINP expr |
	// 		( ':' | '+' | '-' | '*' | '/' | '^' | '%' | '~' | '?' | LT | LE | EQ | NE | GE | GT | AND | OR | AND2 | OR2 | GLOBAL_LEFT_ASSIGN | GLOBAL_RIGHT_ASSIGN | RIGHT_ASSIGN ) expr |
	// 		'(' sublist? ')' |
	// 		'[[' sublist ']]' |
	// 		'[' ','? sublist ','? ']' |
	// 		'$' ( SYMBOL | STR_CONST) |
	...
	{
		if ( !recursion_guard_( builder_, level_, "expr" ) )
			return false;
		boolean result_;
	...
	{
		if ( !recursion_guard_( builder_, level_, "expr_0" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
		...
		if ( !result_ )
			result_ = consumeToken( builder_, R_SYMBOL_FORMALS );
		if ( !result_ )
			result_ = string_literal( builder_, level_ + 1 );
		if ( !result_ )
			result_ = funcall( builder_, level_ + 1 );
		if ( !result_ )
			result_ = expr_0_5( builder_, level_ + 1 );
		if ( !result_ )
			result_ = expr_0_6( builder_, level_ + 1 );
		if ( !result_ )
			result_ = expr_0_7( builder_, level_ + 1 );
		if ( !result_ )
			result_ = expr_0_8( builder_, level_ + 1 );
		if ( !result_ )
			result_ = expr_0_9( builder_, level_ + 1 );
		if ( !result_ )
			result_ = expr_0_10( builder_, level_ + 1 );
		if ( !result_ )
			result_ = expr_0_11( builder_, level_ + 1 );
		if ( !result_ )
			result_ = expr_0_12( builder_, level_ + 1 );
		if ( !result_ )
			result_ = expr_0_13( builder_, level_ + 1 );
		if ( !result_ )
			result_ = fundef( builder_, level_ + 1 );
		if ( !result_ )
			result_ = expr_0_15( builder_, level_ + 1 );
		if ( !result_ )
			result_ = expr_0_16( builder_, level_ + 1 );
		if ( !result_ )
			result_ = expr_0_17( builder_, level_ + 1 );
		if ( !result_ )
			result_ = expr_0_18( builder_, level_ + 1 );
		if ( !result_ )
			result_ = consumeToken( builder_, R_NEXT );
		if ( !result_ )
			result_ = consumeToken( builder_, R_BREAK );
		exit_section_( builder_, marker_, null, result_ );
		return result_;
	}
	...
	{
		if ( !recursion_guard_( builder_, level_, "expr_0_5" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
		result_ = variable( builder_, level_ + 1 );
		result_ = result_ && expr_0_5_1( builder_, level_ + 1 );
		exit_section_( builder_, marker_, null, result_ );
		return result_;
	}

	// (NS_GET SYMBOL | NS_GET STR_CONST | NS_GET_INT SYMBOL | NS_GET_INT STR_CONST)?
	private static boolean expr_0_5_1( PsiBuilder builder_, int level_ )
	{
		if ( !recursion_guard_( builder_, level_, "expr_0_5_1" ) )
			return false;
		expr_0_5_1_0( builder_, level_ + 1 );
		return true;
	}

	// NS_GET SYMBOL | NS_GET STR_CONST | NS_GET_INT SYMBOL | NS_GET_INT STR_CONST
	private static boolean expr_0_5_1_0( PsiBuilder builder_, int level_ )
	{
		if ( !recursion_guard_( builder_, level_, "expr_0_5_1_0" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
		result_ = parseTokens( builder_, 0, R_NS_GET, R_SYMBOL );
		if ( !result_ )
			result_ = parseTokens( builder_, 0, R_NS_GET, R_STR_CONST );
		if ( !result_ )
			result_ = parseTokens( builder_, 0, R_NS_GET_INT, R_SYMBOL );
		if ( !result_ )
			result_ = parseTokens( builder_, 0, R_NS_GET_INT, R_STR_CONST );
		exit_section_( builder_, marker_, null, result_ );
		return result_;
	}
	...
	{
		if ( !recursion_guard_( builder_, level_, "expr_0_6" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
	...
	{
		if ( !recursion_guard_( builder_, level_, "expr_0_7" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
		result_ = consumeToken( builder_, R_LEFT_PAREN );
		result_ = result_ && expr_or_assign( builder_, level_ + 1 );
		result_ = result_ && expr_0_7_2( builder_, level_ + 1 );
		result_ = result_ && consumeToken( builder_, R_RIGHT_PAREN );
		exit_section_( builder_, marker_, null, result_ );
		return result_;
	}
	...
	// ','?
	private static boolean expr_0_7_2( PsiBuilder builder_, int level_ )
	{
		if ( !recursion_guard_( builder_, level_, "expr_0_7_2" ) )
			return false;
	...
	{
		if ( !recursion_guard_( builder_, level_, "expr_0_8" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
		result_ = consumeToken( builder_, R_ARITH_MISC );
		result_ = result_ && expr_or_assign( builder_, level_ + 1 );
		exit_section_( builder_, marker_, null, result_ );
		return result_;
	}
	...
	{
		if ( !recursion_guard_( builder_, level_, "expr_0_9" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
	...
	{
		if ( !recursion_guard_( builder_, level_, "expr_0_10" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
	...
	{
		if ( !recursion_guard_( builder_, level_, "expr_0_11" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
	...
	// '~' expr
	private static boolean expr_0_12( PsiBuilder builder_, int level_ )
	{
		if ( !recursion_guard_( builder_, level_, "expr_0_12" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
	...
	{
		if ( !recursion_guard_( builder_, level_, "expr_0_13" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
	...
	{
		if ( !recursion_guard_( builder_, level_, "expr_0_15" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
		...
		result_ = result_ && expr_or_assign( builder_, level_ + 1 );
		result_ = result_ && expr_0_15_3( builder_, level_ + 1 );
		exit_section_( builder_, marker_, null, result_ );
		return result_;
	}

	// [ELSE expr_or_assign]
	private static boolean expr_0_15_3( PsiBuilder builder_, int level_ )
	{
		if ( !recursion_guard_( builder_, level_, "expr_0_15_3" ) )
			return false;
		expr_0_15_3_0( builder_, level_ + 1 );
		return true;
	}

	// ELSE expr_or_assign
	private static boolean expr_0_15_3_0( PsiBuilder builder_, int level_ )
	{
		if ( !recursion_guard_( builder_, level_, "expr_0_15_3_0" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
	...
	{
		if ( !recursion_guard_( builder_, level_, "expr_0_16" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
	...
	// WHILE cond expr_or_assign
	private static boolean expr_0_17( PsiBuilder builder_, int level_ )
	{
		if ( !recursion_guard_( builder_, level_, "expr_0_17" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
	...
	// REPEAT expr_or_assign
	private static boolean expr_0_18( PsiBuilder builder_, int level_ )
	{
		if ( !recursion_guard_( builder_, level_, "expr_0_18" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
	...
	{
		if ( !recursion_guard_( builder_, level_, "expr_1" ) )
			return false;
		int pos_ = current_position_( builder_ );
		while ( true )
		{
			if ( !expr_1_0( builder_, level_ + 1 ) )
				break;
			if ( !empty_element_parsed_guard_( builder_, "expr_1", pos_ ) )
				break;
			pos_ = current_position_( builder_ );
		}
		return true;
	...
	{
		if ( !recursion_guard_( builder_, level_, "expr_1_0" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
		result_ = expr_1_0_0( builder_, level_ + 1 );
		if ( !result_ )
			result_ = expr_1_0_1( builder_, level_ + 1 );
		if ( !result_ )
			result_ = expr_1_0_2( builder_, level_ + 1 );
		if ( !result_ )
			result_ = expr_1_0_3( builder_, level_ + 1 );
		if ( !result_ )
			result_ = expr_1_0_4( builder_, level_ + 1 );
		if ( !result_ )
			result_ = expr_1_0_5( builder_, level_ + 1 );
		if ( !result_ )
			result_ = expr_1_0_6( builder_, level_ + 1 );
		exit_section_( builder_, marker_, null, result_ );
		return result_;
	}
	...
	{
		if ( !recursion_guard_( builder_, level_, "expr_1_0_0" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
		result_ = consumeToken( builder_, R_PINP );
		result_ = result_ && expr( builder_, level_ + 1 );
		exit_section_( builder_, marker_, null, result_ );
		return result_;
	}
	...
	{
		if ( !recursion_guard_( builder_, level_, "expr_1_0_1" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
	...
	// ':' | '+' | '-' | '*' | '/' | '^' | '%' | '~' | '?' | LT | LE | EQ | NE | GE | GT | AND | OR | AND2 | OR2 | GLOBAL_LEFT_ASSIGN | GLOBAL_RIGHT_ASSIGN | RIGHT_ASSIGN
	private static boolean expr_1_0_1_0( PsiBuilder builder_, int level_ )
	{
		if ( !recursion_guard_( builder_, level_, "expr_1_0_1_0" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
		...
		if ( !result_ )
			result_ = consumeToken( builder_, R_ARITH_MINUS );
		if ( !result_ )
			result_ = consumeToken( builder_, R_ARITH_MULT );
		if ( !result_ )
			result_ = consumeToken( builder_, R_ARITH_DIV );
		if ( !result_ )
			result_ = consumeToken( builder_, R_ARITH_EXPONENTIAION );
		if ( !result_ )
			result_ = consumeToken( builder_, R_ARITH_MOD );
		if ( !result_ )
			result_ = consumeToken( builder_, R_TILDE );
		if ( !result_ )
			result_ = consumeToken( builder_, R_QUESTION );
		if ( !result_ )
			result_ = consumeToken( builder_, R_LT );
		if ( !result_ )
			result_ = consumeToken( builder_, R_LE );
		if ( !result_ )
			result_ = consumeToken( builder_, R_EQ );
		if ( !result_ )
			result_ = consumeToken( builder_, R_NE );
		if ( !result_ )
			result_ = consumeToken( builder_, R_GE );
		if ( !result_ )
			result_ = consumeToken( builder_, R_GT );
		if ( !result_ )
			result_ = consumeToken( builder_, R_AND );
		if ( !result_ )
			result_ = consumeToken( builder_, R_OR );
		if ( !result_ )
			result_ = consumeToken( builder_, R_AND2 );
		if ( !result_ )
			result_ = consumeToken( builder_, R_OR2 );
		if ( !result_ )
			result_ = consumeToken( builder_, R_GLOBAL_LEFT_ASSIGN );
		if ( !result_ )
			result_ = consumeToken( builder_, R_GLOBAL_RIGHT_ASSIGN );
		if ( !result_ )
			result_ = consumeToken( builder_, R_RIGHT_ASSIGN );
		exit_section_( builder_, marker_, null, result_ );
		return result_;
	}
	...
	{
		if ( !recursion_guard_( builder_, level_, "expr_1_0_2" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
		result_ = consumeToken( builder_, R_LEFT_PAREN );
		result_ = result_ && expr_1_0_2_1( builder_, level_ + 1 );
		result_ = result_ && consumeToken( builder_, R_RIGHT_PAREN );
		exit_section_( builder_, marker_, null, result_ );
		return result_;
	}
	...
	// sublist?
	private static boolean expr_1_0_2_1( PsiBuilder builder_, int level_ )
	{
		if ( !recursion_guard_( builder_, level_, "expr_1_0_2_1" ) )
			return false;
	...
	{
		if ( !recursion_guard_( builder_, level_, "expr_1_0_3" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
	...
	{
		if ( !recursion_guard_( builder_, level_, "expr_1_0_4" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
		...
		result_ = result_ && sublist( builder_, level_ + 1 );
		result_ = result_ && expr_1_0_4_3( builder_, level_ + 1 );
	...
	{
		if ( !recursion_guard_( builder_, level_, "expr_1_0_4_1" ) )
			return false;
		consumeToken( builder_, R_COMMA );
		return true;
	}
	...
	// ','?
	private static boolean expr_1_0_4_3( PsiBuilder builder_, int level_ )
	{
		if ( !recursion_guard_( builder_, level_, "expr_1_0_4_3" ) )
			return false;
		consumeToken( builder_, R_COMMA );
		return true;
	}
	...
	{
		if ( !recursion_guard_( builder_, level_, "expr_1_0_5" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
	...
	{
		if ( !recursion_guard_( builder_, level_, "expr_1_0_5_1" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
	...
	{
		if ( !recursion_guard_( builder_, level_, "expr_1_0_6" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
		result_ = consumeToken( builder_, R_SLOT );
		result_ = result_ && expr_1_0_6_1( builder_, level_ + 1 );
		exit_section_( builder_, marker_, null, result_ );
		return result_;
	}

	// SYMBOL | STR_CONST
	private static boolean expr_1_0_6_1( PsiBuilder builder_, int level_ )
	{
		if ( !recursion_guard_( builder_, level_, "expr_1_0_6_1" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
		result_ = consumeToken( builder_, R_SYMBOL );
	...
	/* ********************************************************** */
	// EOL* ( expr [(EQ_ASSIGN | LEFT_ASSIGN) expr_or_assign] )
	public static boolean expr_or_assign( PsiBuilder builder_, int level_ )
	{
		if ( !recursion_guard_( builder_, level_, "expr_or_assign" ) )
			return false;
		boolean result_;
	...
	{
		if ( !recursion_guard_( builder_, level_, "expr_or_assign_0" ) )
			return false;
		int pos_ = current_position_( builder_ );
		while ( true )
		{
			if ( !consumeToken( builder_, R_EOL ) )
				break;
			if ( !empty_element_parsed_guard_( builder_, "expr_or_assign_0", pos_ ) )
				break;
			pos_ = current_position_( builder_ );
		}
		return true;
	...
	// expr [(EQ_ASSIGN | LEFT_ASSIGN) expr_or_assign]
	private static boolean expr_or_assign_1( PsiBuilder builder_, int level_ )
	{
		if ( !recursion_guard_( builder_, level_, "expr_or_assign_1" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
		result_ = expr( builder_, level_ + 1 );
		result_ = result_ && expr_or_assign_1_1( builder_, level_ + 1 );
		exit_section_( builder_, marker_, null, result_ );
		return result_;
	}

	// [(EQ_ASSIGN | LEFT_ASSIGN) expr_or_assign]
	private static boolean expr_or_assign_1_1( PsiBuilder builder_, int level_ )
	{
		if ( !recursion_guard_( builder_, level_, "expr_or_assign_1_1" ) )
			return false;
		expr_or_assign_1_1_0( builder_, level_ + 1 );
		return true;
	}

	// (EQ_ASSIGN | LEFT_ASSIGN) expr_or_assign
	private static boolean expr_or_assign_1_1_0( PsiBuilder builder_, int level_ )
	{
		if ( !recursion_guard_( builder_, level_, "expr_or_assign_1_1_0" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
		result_ = expr_or_assign_1_1_0_0( builder_, level_ + 1 );
		result_ = result_ && expr_or_assign( builder_, level_ + 1 );
		exit_section_( builder_, marker_, null, result_ );
		return result_;
	}
	...
	private static boolean expr_or_assign_1_1_0_0( PsiBuilder builder_, int level_ )
	{
		if ( !recursion_guard_( builder_, level_, "expr_or_assign_1_1_0_0" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
		result_ = consumeToken( builder_, R_EQ_ASSIGN );
		if ( !result_ )
			result_ = consumeToken( builder_, R_LEFT_ASSIGN );
		exit_section_( builder_, marker_, null, result_ );
		return result_;
	}
	...
	{
		if ( !recursion_guard_( builder_, level_, "exprlist" ) )
			return false;
		boolean result_;
	...
	{
		if ( !recursion_guard_( builder_, level_, "exprlist_0" ) )
			return false;
	...
	{
		if ( !recursion_guard_( builder_, level_, "exprlist_0_0" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
	...
	{
		if ( !recursion_guard_( builder_, level_, "exprlist_0_0_0" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
		result_ = expr_or_assign( builder_, level_ + 1 );
	...
	{
		if ( !recursion_guard_( builder_, level_, "exprlist_0_0_1" ) )
			return false;
		int pos_ = current_position_( builder_ );
		while ( true )
		{
			if ( !exprlist_0_0_1_0( builder_, level_ + 1 ) )
				break;
			if ( !empty_element_parsed_guard_( builder_, "exprlist_0_0_1", pos_ ) )
				break;
			pos_ = current_position_( builder_ );
		}
		return true;
	...
	{
		if ( !recursion_guard_( builder_, level_, "exprlist_0_0_1_0" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
		result_ = exprlist_0_0_1_0_0( builder_, level_ + 1 );
		if ( !result_ )
			result_ = exprlist_0_0_1_0_1( builder_, level_ + 1 );
		if ( !result_ )
	...
	{
		if ( !recursion_guard_( builder_, level_, "exprlist_0_0_1_0_0" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
		result_ = consumeToken( builder_, R_SEMICOLON );
	...
	{
		if ( !recursion_guard_( builder_, level_, "exprlist_0_0_1_0_1" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
		result_ = consumeToken( builder_, R_EOL );
	...
	{
		if ( !recursion_guard_( builder_, level_, "exprlist_1" ) )
			return false;
		int pos_ = current_position_( builder_ );
		while ( true )
		{
			if ( !consumeToken( builder_, R_EOL ) )
				break;
			if ( !empty_element_parsed_guard_( builder_, "exprlist_1", pos_ ) )
				break;
			pos_ = current_position_( builder_ );
		}
		return true;
	...
	{
		if ( !recursion_guard_( builder_, level_, "fd_argument" ) )
			return false;
		boolean result_;
		...
		if ( !result_ )
			result_ = consumeToken( builder_, R_SYMBOL );
		if ( !result_ )
			result_ = fd_argument_2( builder_, level_ + 1 );
		if ( !result_ )
			result_ = consumeToken( builder_, R_STR_CONST );
		if ( !result_ )
			result_ = consumeToken( builder_, R_SYMBOL_FORMALS );
	...
	{
		if ( !recursion_guard_( builder_, level_, "fd_argument_0" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
		result_ = consumeToken( builder_, R_SYMBOL );
	...
	{
		if ( !recursion_guard_( builder_, level_, "fd_argument_2" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
		result_ = consumeToken( builder_, R_STR_CONST );
	...
	{
		if ( !recursion_guard_( builder_, level_, "forcond" ) )
			return false;
		if ( !nextTokenIs( builder_, R_LEFT_PAREN ) )
			return false;
		boolean result_;
	...
	/* ********************************************************** */
	// variable '(' EOL? sublist? ')'
	public static boolean funcall( PsiBuilder builder_, int level_ )
	{
		if ( !recursion_guard_( builder_, level_, "funcall" ) )
			return false;
		if ( !nextTokenIs( builder_, R_SYMBOL ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
		result_ = variable( builder_, level_ + 1 );
		...
		result_ = result_ && funcall_3( builder_, level_ + 1 );
		result_ = result_ && consumeToken( builder_, R_RIGHT_PAREN );
	...
	{
		if ( !recursion_guard_( builder_, level_, "funcall_2" ) )
			return false;
	...
	// sublist?
	private static boolean funcall_3( PsiBuilder builder_, int level_ )
	{
		if ( !recursion_guard_( builder_, level_, "funcall_3" ) )
			return false;
		sublist( builder_, level_ + 1 );
		return true;
	}
	...
	{
		if ( !recursion_guard_( builder_, level_, "fundef" ) )
			return false;
		if ( !nextTokenIs( builder_, R_FUNCTION ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
	...
	{
		if ( !recursion_guard_( builder_, level_, "fundef_2" ) )
			return false;
	...
	{
		if ( !recursion_guard_( builder_, level_, "fundef_args" ) )
			return false;
		boolean result_;
	...
	{
		if ( !recursion_guard_( builder_, level_, "fundef_args_1" ) )
			return false;
		int pos_ = current_position_( builder_ );
		while ( true )
		{
			if ( !fundef_args_1_0( builder_, level_ + 1 ) )
				break;
			if ( !empty_element_parsed_guard_( builder_, "fundef_args_1", pos_ ) )
				break;
			pos_ = current_position_( builder_ );
		}
		return true;
	...
	{
		if ( !recursion_guard_( builder_, level_, "fundef_args_1_0" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
	...
	{
		if ( !recursion_guard_( builder_, level_, "fundef_args_1_0_0" ) )
			return false;
		consumeToken( builder_, R_EOL );
		return true;
	}
	...
	{
		if ( !recursion_guard_( builder_, level_, "fundef_args_1_0_2" ) )
			return false;
		consumeToken( builder_, R_EOL );
		return true;
	}
	...
	{
		if ( !recursion_guard_( builder_, level_, "section" ) )
			return false;
		if ( !nextTokenIs( builder_, R_SECTION_COMMENT ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
	...
	{
		if ( !recursion_guard_( builder_, level_, "string_literal" ) )
			return false;
		if ( !nextTokenIs( builder_, R_STR_CONST ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
		result_ = consumeToken( builder_, R_STR_CONST );
	...
	{
		if ( !recursion_guard_( builder_, level_, "sub" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_, level_, _NONE_, "<sub>" );
		result_ = sub_0( builder_, level_ + 1 );
		if ( !result_ )
			result_ = sub_1( builder_, level_ + 1 );
		if ( !result_ )
			result_ = sub_2( builder_, level_ + 1 );
		if ( !result_ )
			result_ = consumeToken( builder_, R_SYMBOL_FORMALS );
		if ( !result_ )
			result_ = expr( builder_, level_ + 1 );
	...
	{
		if ( !recursion_guard_( builder_, level_, "sub_0" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
		result_ = consumeToken( builder_, R_SYMBOL );
	...
	{
		if ( !recursion_guard_( builder_, level_, "sub_1" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
		result_ = consumeToken( builder_, R_STR_CONST );
	...
	{
		if ( !recursion_guard_( builder_, level_, "sub_2" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
		result_ = consumeToken( builder_, R_NULL_CONST );
	...
	{
		if ( !recursion_guard_( builder_, level_, "sublist" ) )
			return false;
		boolean result_;
		...
		result_ = result_ && sublist_2( builder_, level_ + 1 );
	...
	{
		if ( !recursion_guard_( builder_, level_, "sublist_1" ) )
			return false;
		int pos_ = current_position_( builder_ );
		while ( true )
		{
			if ( !sublist_1_0( builder_, level_ + 1 ) )
				break;
			if ( !empty_element_parsed_guard_( builder_, "sublist_1", pos_ ) )
				break;
			pos_ = current_position_( builder_ );
		}
		return true;
	...
	{
		if ( !recursion_guard_( builder_, level_, "sublist_1_0" ) )
			return false;
		boolean result_;
		Marker marker_ = enter_section_( builder_ );
	...
	{
		if ( !recursion_guard_( builder_, level_, "sublist_1_0_0" ) )
			return false;
		consumeToken( builder_, R_EOL );
		return true;
	}
	...
	{
		if ( !recursion_guard_( builder_, level_, "sublist_1_0_2" ) )
			return false;
		consumeToken( builder_, R_EOL );
		return true;
	}
	...
	// (EOL)*
	private static boolean sublist_2( PsiBuilder builder_, int level_ )
	{
		if ( !recursion_guard_( builder_, level_, "sublist_2" ) )
			return false;
		int pos_ = current_position_( builder_ );
		while ( true )
		{
			if ( !consumeToken( builder_, R_EOL ) )
				break;
			if ( !empty_element_parsed_guard_( builder_, "sublist_2", pos_ ) )
				break;
			pos_ = current_position_( builder_ );
		}
		return true;
	...
	{
		if ( !recursion_guard_( builder_, level_, "variable" ) )
			return false;
		if ( !nextTokenIs( builder_, R_SYMBOL ) )
			return false;
		boolean result_;
